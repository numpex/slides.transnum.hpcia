...
\begin{itemize}
    ...
    \item AI and HPC software have different lifecyles, AI-based frameworks are rapidly evolving while the HPC software /application code evolution longer lifecycles. Is  \\
