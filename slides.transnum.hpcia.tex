...
\begin{itemize}
  \item A \textbf{shared vision} (5--7 key messages) for CSA positioning
...
\vspace{0.2cm}
\small{\emph{This checklist will be used to evaluate each pilot and prioritize 2028/2030 actions.}}
